      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          {LESSONS.map((carBrand) => (
            ...
            >
              <div className="relative w-12 h-12 bg-black/30 rounded-lg p-2 flex items-center justify-center overflow-hidden shrink-0">
                <Image
                  src={logos[carBrand.id] || "/home-icon.webp"}
